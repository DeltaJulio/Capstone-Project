...
import io.github.deltajulio.pantrybank.dummy.DummyContent.DummyItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link DummyItem} and makes a call to the
 * specified {@link MainFragmentListener}.
...
public class MyPantryRecyclerViewAdapter extends RecyclerView.Adapter<MyPantryRecyclerViewAdapter.ViewHolder>
{
    ...
    private final MainFragmentListener mListener;

    public MyPantryRecyclerViewAdapter(List<DummyItem> items, MainFragmentListener listener)
    {
        mValues = items;
        mListener = listener;
    }
